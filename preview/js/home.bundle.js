...
/******/ 	var hotCurrentHash = "33f345029b4f1447cbd9"; // eslint-disable-line no-unused-vars
...
module.exports = (__webpack_require__(2))(299);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($, d3, dialog) {

Object.defineProperty(exports, "__esModule", {
    value: true
});

var _exportExcel = __webpack_require__(20);

//导出excel模块

exports.default = {
    //自动缩放
    autoZoom: function autoZoom(json) {
    ...
    //导出excel
    exportExcel: function exportExcel(json) {
        if (json["links"].length) {
            var convertData = JSON.parse(JSON.stringify(json["links"]));
            var convertDataExtract = [];
            ...
            (0, _exportExcel.downloadExl)(convertDataExtract);
        } else {
            this.tip("没有连接线数据可导出！");
        }
    },
...
function __delNode(json, update, selNode) {
    ...
    if (selNode.length == 1) {
        ...
        for (var linkIdx = 0; linkIdx < json.links.length; linkIdx++) {
...
exports.default = function () {
  d3.select("#J_ExportPng").on("click", function () {
    if ($("#J_SvgView").size()) {
      ...
      var transform = $all.attr("transform");
      var scale = transform && /scale/.test(transform) ? +transform.match(/scale\(([^\)]+)\)/)[1] : 1;
      var allPos = $all[0].getBoundingClientRect();
      var left = allPos.left - $graphArea.offset().left - 15 * scale;
      var top = allPos.top - $graphArea.offset().top;
      var width = allPos.width + 30 * scale;
      var height = allPos.height;
      _saveSvgAsPng2.default.saveSvgAsPng($("#J_SvgView")[0], "\u56FE\u7247\u9884\u89C8" + +new Date() + ".png", { left: left, top: top, width: width, height: height });
    }
  });
};

var _saveSvgAsPng = __webpack_require__(25);
...
exports.default = function () {
    ...
    return d3.forceSimulation([]).force("link", d3.forceLink([]).id(function (d) {
        return d.id;
    }).distance(100)).force("charge", d3.forceManyBody().strength(-2500)).force("center", d3.forceCenter($('.graph-area').width() / 2, $('.graph-area').height() / 2)).force("x", d3.forceX()).force("y", d3.forceY()).force("collide", d3.forceCollide().strength(0.2).iterations(5));
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(1)))
...
exports.default = function (json, vis) {
    var colors = d3.schemeCategory10,
        groupMap = {};
    var groups = [].concat(_toConsumableArray(new Set(json.nodes.reduce(function (prev, cur) {
        return prev.concat(cur.group);
    }, []))));
    groups.forEach(function (groupItem, groupIdx) {
        groupMap[groupItem] = colors[groupIdx];
    });
    var node = vis.selectAll("g.node");
    node = node.data(json["nodes"], function (d) {
        return d["id"];
    });
    node.exit().remove();
    ...
    node.append('svg:circle').attr("class", "node-bg").attr("r", "12px").attr("fill", "#5bc0de");
    node.append("svg:image").attr("class", "node-icon").attr("xlink:href", _node2.default).attr("x", "-10px").attr("y", "-10px").attr("width", "20px").attr("height", "20px");
    node.append("svg:text").attr("class", "node-name").attr("dy", "25px").attr("text-anchor", "middle").attr("fill", "#5bc0de").text(function (d) {
        return d["id"];
    });
    node.append("svg:text").attr("class", "node-group").attr("dy", function (d) {
        return d["id"] ? "40px" : "25px";
    }).attr("text-anchor", "middle").attr("font-size", "12px").attr("fill", "#286090").html(function (d) {
        return d["group"].length ? ("【" + d["group"].reduce(function (prev, cur) {
...
var _node = __webpack_require__(23);
...
exports.default = function () {
    var _ref = [$(".graph-area").width(), $(".graph-area").height()],
        width = _ref[0],
        height = _ref[1];
...
var ct = (0, _contextmenu2.default)();
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(1)))
...
/* WEBPACK VAR INJECTION */(function(process) {/*! art-template@4.12.2 for browser | https://github.com/aui/art-template */
...
exports.default = function () {
    return {
        ...
        showContextMenu: function showContextMenu(obj) {
            var contextMenuTpl = "\n\t\t\t<div class=\"title\">\n\t\t\t   {{title}}    \n\t\t\t</div>\n\t\t\t<table class=\"context-menu-item\">\n\t\t\t    {{each list listItem}}\n\t\t\t      <tr>\n\t\t\t          <td>\n\t\t\t              <span class=\"menu-item-btn {{listItem.class}}\">{{listItem.text}}</span>\n\t\t\t          </td>\n\t\t\t      </tr>\n\t\t\t    {{/each}}\n\t\t\t</div>\n     \t";

            if (obj) {
                contextmenu.html(_templateWeb2.default.render(contextMenuTpl, obj.contextmenuData)).style("left", d3.event.pageX + "px").style("top", d3.event.pageY + "px").style("display", "block");
            } else {
...
var _templateWeb = __webpack_require__(17);
...
var contextmenu = d3.select("body").append("div").attr("class", "graph-contextmenu");
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function(XLSX) {
...
var _bindLinkAndNodeEvent2 = __webpack_require__(14);

var _bindLinkAndNodeEvent3 = _interopRequireDefault(_bindLinkAndNodeEvent2);
...
//公共方法
//引入自定义样式
/*_api2.default.getData().always(function (rps) {
    if (rps["success"] && rps["result"]) {
     //xxx
    }
});*/
//为了演示 暂时把下面东西从上面方法拿出来了
var _rps = {
    "success": true,
    "result": {
        "nodes": [{ "id": "Myriel", "group": ["小广告"] }, { "id": "Napoleon", "group": ["小广告"] }, { "id": "Mlle.Baptistine", "group": ["小广告"] }, { "id": "Mme.Magloire", "group": ["小广告"] }, { "id": "CountessdeLo", "group": ["小广告"] }, { "id": "Geborand", "group": ["小广告"] }, { "id": "Champtercier", "group": ["小广告"] }, { "id": "Cravatte", "group": ["小广告"] }, { "id": "Count", "group": ["小广告"] }, { "id": "OldMan", "group": ["小广告"] }, { "id": "Labarre", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Valjean", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Marguerite", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Mme.deR", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Isabeau", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Gervais", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Tholomyes", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Listolier", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Fameuil", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Blacheville", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Favourite", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Dahlia", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Zephine", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Fantine", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Mme.Thenardier", "group": ["骚扰电话"] }, { "id": "Thenardier", "group": ["骚扰电话"] }, { "id": "Cosette", "group": ["小广告", "中介"] }, { "id": "Javert", "group": ["骚扰电话"] }, { "id": "Fauchelevent", "group": ["中介", "骚扰电话"] }, { "id": "Bamatabois", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Perpetue", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Simplice", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Scaufflaire", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Woman1", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Judge", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Champmathieu", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Brevet", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Chenildieu", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Cochepaille", "group": ["小广告", "中介", "骚扰电话"] }, { "id": "Pontmercy", "group": ["骚扰电话"] }, { "id": "Boulatruelle", "group": ["骚扰电话", "中介"] }, { "id": "Eponine", "group": ["骚扰电话"] }, { "id": "Anzelma", "group": ["骚扰电话"] }, { "id": "Woman2", "group": ["小广告", "中介"] }, { "id": "MotherInnocent", "group": ["中介", "骚扰电话"] }, { "id": "Gribier", "group": ["中介", "骚扰电话"] }, { "id": "Jondrette", "group": ["小广告", "中介"] }, { "id": "Mme.Burgon", "group": ["小广告", "中介"] }, { "id": "Gavroche", "group": ["中介"] }, { "id": "Gillenormand", "group": ["小广告", "中介"] }, { "id": "Magnon", "group": ["小广告", "中介"] }, { "id": "Mlle.Gillenormand", "group": ["小广告", "中介"] }, { "id": "Mme.Pontmercy", "group": ["小广告", "中介"] }, { "id": "Mlle.Vaubois", "group": ["小广告", "中介"] }, { "id": "Lt.Gillenormand", "group": ["小广告", "中介"] }, { "id": "Marius", "group": ["中介"] }, { "id": "BaronessT", "group": ["小广告", "中介"] }, { "id": "Mabeuf", "group": ["中介"] }, { "id": "Enjolras", "group": ["中介"] }, { "id": "Combeferre", "group": ["中介"] }, { "id": "Prouvaire", "group": ["中介"] }, { "id": "Feuilly", "group": ["中介"] }, { "id": "Courfeyrac", "group": ["中介"] }, { "id": "Bahorel", "group": ["中介"] }, { "id": "Bossuet", "group": ["中介"] }, { "id": "Joly", "group": ["中介"] }, { "id": "Grantaire", "group": ["中介"] }, { "id": "MotherPlutarch", "group": ["中介", "骚扰电话"] }, { "id": "Gueulemer", "group": ["骚扰电话"] }, { "id": "Babet", "group": ["骚扰电话"] }, { "id": "Claquesous", "group": ["骚扰电话"] }, { "id": "Montparnasse", "group": ["骚扰电话"] }, { "id": "Toussaint", "group": ["小广告", "中介"] }, { "id": "Child1", "group": ["小广告"] }, { "id": "Child2", "group": ["小广告"] }, { "id": "Brujon", "group": ["骚扰电话"] }, { "id": "Mme.Hucheloup", "group": ["中介"] }],
...
var json = Object.prototype.toString.call(_rps["result"]) == "[object String]" ? JSON.parse(_rps["result"]) : _rps["result"];
graphInit(json);
...
function graphInit(json) {
    ...
    var force = (0, _force3.default)(); //力导向图布局
    var exportPng = (0, _exportPng3.default)(); //导出图片
    function update() {
        //转换数据
