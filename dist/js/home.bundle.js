...
exports.default = function (json) {
    return d3.forceSimulation().nodes(json.nodes).force("link", d3.forceLink(json.links).distance(100)).force("charge", d3.forceManyBody()).force("center", d3.forceCenter(window.innerWidth / 2, window.innerHeight / 2)).force("charge", d3.forceManyBody()).force("collide", d3.forceCollide(60).strength(0.2).iterations(5));
};
...
exports.default = function (json, vis) {
    return vis.selectAll('.linetext').data(json.links).enter().append("text").append('svg:textPath').attr("class", "linetext").attr("startOffset", "50%").attr("text-anchor", "middle").attr("xlink:href", function (d) {
...
exports.default = function (json, vis) {
    return vis.selectAll("line.link").data(json.links).enter().append("svg:path").attr("class", "link").attr('stroke-width', 1).attr('id', function (d) {
        return d.source.index + '_' + d.target.index;
...
exports.default = function (json, vis) {
    var _node = vis.selectAll("g.node").data(json.nodes).enter().append("svg:g").attr("class", "node");
...
exports.default = function (force, tick, link, node) {
    ...
    var _nodeDrag = d3.drag().on("start", dragstart).on("drag", dragmove).on("end", dragend);
    return _nodeDrag;
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
exports.default = function (json) {
    ...
    var _vis = d3.select("body").append("svg:svg").attr("width", window.innerWidth).attr("height", window.innerHeight).call(zoom).on("dblclick.zoom", null).append('g').attr('class', 'all');
